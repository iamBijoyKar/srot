    ...
    <header className="h-16 px-4 sm:px-6 md:px-8 py-2 w-full flex items-center justify-between bg-primary-bg  ">
      ...
      <SignedIn>
        <div className="flex items-center gap-4">
          <Link
            href="/dashboard"
            className="px-2 py-1 flex justify-center items-center text-primary-text text-md rounded bg-gradient-to-r from-brand-purple to-brand-pink hover:drop-shadow-[0_35px_35px_rgb(var(--brand-purple))] transition-all duration-100"
          >
